...
/* harmony import */ var _shared_optic_material_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/optic.material.module */ "./src/app/shared/optic.material.module.ts");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _main_load_main_load_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main-load/main-load.module */ "./src/app/main-load/main-load.module.ts");
/* harmony import */ var _top_menu_top_menu_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./top-menu/top-menu.module */ "./src/app/top-menu/top-menu.module.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_11__["ForgetPasswordComponent"]
            ],
            imports: [
                ...
                _shared_optic_material_module__WEBPACK_IMPORTED_MODULE_7__["OpticCustomMaterialModule"],
                _main_load_main_load_module__WEBPACK_IMPORTED_MODULE_9__["MainLoadModule"],
                _top_menu_top_menu_module__WEBPACK_IMPORTED_MODULE_10__["TopMenuModule"],
...
/*!*******************************************************!*\
  !*** ./src/app/custom-validators/custom-validator.ts ***!
  \*******************************************************/
/*! exports provided: passValidator, UsernameValidator, pincodeValidator, forgetpassValidator, account_validation_messages, ForgetPassword_validation_messages */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "forgetpassValidator", function() { return forgetpassValidator; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ForgetPassword_validation_messages", function() { return ForgetPassword_validation_messages; });
...
function forgetpassValidator(control) {
    if (control && (control.value !== null || control.value !== undefined)) {
        var cnfpassValue = control.value;
        var passControl = control.root.get('newPassword');
        if (passControl) {
            var passValue = passControl.value;
            if (passValue !== cnfpassValue || passValue === '') {
                return {
...
var ForgetPassword_validation_messages = {
    'temppassword': [
...
/* harmony import */ var src_app_custom_validators_custom_validator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/custom-validators/custom-validator */ "./src/app/custom-validators/custom-validator.ts");
...
var ForgetPasswordComponent = /** @class */ (function () {
    function ForgetPasswordComponent(route, router, loginservice, fb, snackbar) {
        this.route = route;
        this.router = router;
        ...
        this.UpdatePasswordForm = this.fb.group({
            ...
            cnfPassword: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                    src_app_custom_validators_custom_validator__WEBPACK_IMPORTED_MODULE_5__["forgetpassValidator"]
                ])],
            fk_companyid: [''],
            uuid: ['']
        });
    ...
    ForgetPasswordComponent.prototype.OnChangePassword = function () {
        var _this = this;
    ...
    ForgetPasswordComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], src_app_services_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatSnackBar"]])
...
/***/ "./src/app/guards/token-interceptor.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/guards/token-interceptor.service.ts ***!
  \*****************************************************/
...
/***/ "./src/app/main-load/main-load.module.ts":
/*!***********************************************!*\
  !*** ./src/app/main-load/main-load.module.ts ***!
  \***********************************************/
/*! exports provided: MainLoadModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainLoadModule", function() { return MainLoadModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _guards_token_interceptor_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../guards/token-interceptor.service */ "./src/app/guards/token-interceptor.service.ts");
...
var routes = [
    ...
    { path: 'forget-password/:uuid', component: _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_4__["ForgetPasswordComponent"] },
    { path: '**', redirectTo: '/login', pathMatch: 'full' }
];
var MainLoadModule = /** @class */ (function () {
    function MainLoadModule() {
    }
    MainLoadModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forRoot(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]],
            providers: [{ provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _guards_token_interceptor_service__WEBPACK_IMPORTED_MODULE_3__["TokenInterceptorService"], multi: true }]
        })
    ], MainLoadModule);
    return MainLoadModule;
}());
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.adminLogin = function (adminlogin) {
        return this.httpClient.post("" + _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].adminLoginURL(), adminlogin);
    };
    ...
    LoginService.prototype.getUserName = function () {
        var _this = this;
        if (this.currentUser) {
            return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) { return observer.next(_this.currentUser); });
        }
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (observer) {
            _this.httpClient.get("" + _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].getUserNameURL()).subscribe(function (data) {
    ...
    LoginService.prototype.forgetPassword = function (adminlogin) {
        return this.httpClient.post("" + _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].forgetPasswordURL(), adminlogin);
    };
    LoginService.prototype.getforgetPassword = function (id) {
        return this.httpClient.get("" + _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].getforgetPasswordURL() + ("/" + id));
    };
    LoginService.prototype.updateforgetPassword = function (forgetpassword) {
        return this.httpClient.put("" + _utils__WEBPACK_IMPORTED_MODULE_2__["Utils"].UpdateforgetPasswordURL() + ("/" + forgetpassword.fk_companyid), forgetpassword);
    };
...
/***/ "./src/app/shared/optic.material.module.ts":
/*!*************************************************!*\
  !*** ./src/app/shared/optic.material.module.ts ***!
  \*************************************************/
/*! exports provided: OpticCustomMaterialModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OpticCustomMaterialModule", function() { return OpticCustomMaterialModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var OpticCustomMaterialModule = /** @class */ (function () {
    function OpticCustomMaterialModule(iconRegistry, sanitizer) {
        iconRegistry.addSvgIcon('add_employee', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/add_employee.svg'));
        iconRegistry.addSvgIcon('box', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/box.svg'));
        iconRegistry.addSvgIcon('brand', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/brand.svg'));
        iconRegistry.addSvgIcon('dashboard', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/dashboard.svg'));
        iconRegistry.addSvgIcon('employee', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/employee.svg'));
        iconRegistry.addSvgIcon('frame_material', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/frame_material.svg'));
        iconRegistry.addSvgIcon('frame_type', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/frame_type.svg'));
        iconRegistry.addSvgIcon('lens', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/lens.svg'));
        iconRegistry.addSvgIcon('list_employee', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/list_employee.svg'));
        iconRegistry.addSvgIcon('product', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/product.svg'));
        iconRegistry.addSvgIcon('spects', sanitizer.bypassSecurityTrustResourceUrl('assets/icons/spects.svg'));
    }
    OpticCustomMaterialModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
    ...
    return OpticCustomMaterialModule;
}());
...
/***/ "./src/app/top-menu/fullscreen/fullscreen.component.html":
/*!***************************************************************!*\
  !*** ./src/app/top-menu/fullscreen/fullscreen.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/fullscreen/fullscreen.component.scss":
/*!***************************************************************!*\
  !*** ./src/app/top-menu/fullscreen/fullscreen.component.scss ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/fullscreen/fullscreen.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/top-menu/fullscreen/fullscreen.component.ts ***!
  \*************************************************************/
...
var FullscreenComponent = /** @class */ (function () {
    ...
    FullscreenComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./fullscreen.component.html */ "./src/app/top-menu/fullscreen/fullscreen.component.html"),
            styles: [__webpack_require__(/*! ./fullscreen.component.scss */ "./src/app/top-menu/fullscreen/fullscreen.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], FullscreenComponent);
...
/***/ "./src/app/top-menu/search-bar/search-bar.component.html":
/*!***************************************************************!*\
  !*** ./src/app/top-menu/search-bar/search-bar.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/search-bar/search-bar.component.scss":
/*!***************************************************************!*\
  !*** ./src/app/top-menu/search-bar/search-bar.component.scss ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/search-bar/search-bar.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/top-menu/search-bar/search-bar.component.ts ***!
  \*************************************************************/
...
var SearchBarComponent = /** @class */ (function () {
    ...
    SearchBarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./search-bar.component.html */ "./src/app/top-menu/search-bar/search-bar.component.html"),
            styles: [__webpack_require__(/*! ./search-bar.component.scss */ "./src/app/top-menu/search-bar/search-bar.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], SearchBarComponent);
...
/***/ "./src/app/top-menu/sidebar/sidebar.component.html":
/*!*********************************************************!*\
  !*** ./src/app/top-menu/sidebar/sidebar.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/sidebar/sidebar.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/top-menu/sidebar/sidebar.component.ts ***!
  \*******************************************************/
...
var SidebarComponent = /** @class */ (function () {
    ...
    SidebarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./sidebar.component.html */ "./src/app/top-menu/sidebar/sidebar.component.html"),
            styles: [__webpack_require__(/*! ./sidebar.component.scss */ "./src/app/top-menu/sidebar/sidebar.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], SidebarComponent);
...
/***/ "./src/app/top-menu/sidemenu-item/sidemenu-item.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/top-menu/sidemenu-item/sidemenu-item.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/sidemenu-item/sidemenu-item.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/top-menu/sidemenu-item/sidemenu-item.component.ts ***!
  \*******************************************************************/
...
var SidemenuItemComponent = /** @class */ (function () {
    ...
    SidemenuItemComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./sidemenu-item.component.html */ "./src/app/top-menu/sidemenu-item/sidemenu-item.component.html"),
            styles: [__webpack_require__(/*! ./sidemenu-item.component.scss */ "./src/app/top-menu/sidemenu-item/sidemenu-item.component.scss")]
        }),
        __metadata("design:paramtypes", [])
...
/***/ "./src/app/top-menu/sidemenu/menu-element.ts":
/*!***************************************************!*\
  !*** ./src/app/top-menu/sidemenu/menu-element.ts ***!
  \***************************************************/
/*! exports provided: adminmenus, Employee_menus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "adminmenus", function() { return adminmenus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Employee_menus", function() { return Employee_menus; });
var adminmenus = [
    {
        'name': 'Dashboard',
        'icon': 'dashboard',
...
/***/ "./src/app/top-menu/sidemenu/sidemenu.component.html":
/*!***********************************************************!*\
  !*** ./src/app/top-menu/sidemenu/sidemenu.component.html ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n<perfect-scrollbar style=\"height: calc(100% - 33px);\">\n  <div fxLayout=\"column\" >\n      <!-- <div *ngIf=\"!iconOnly\" fxLayoutAlign=\"space-around center\" [style.margin]=\"'10px 0px'\" >\n        <img width=\"100\" [style.borderRadius]=\"'50%'\" src=\"./assets/paalan.jpg\">\n      </div> -->\n      <div *ngIf=\"iconOnly\" style=\"height: 100px;\" fxLayoutAlign=\"space-around center\"  >\n          <img width=\"50\" [style.borderRadius]=\"'50%'\" src=\"./assets/camera.png\">\n      </div>\n      <app-sidemenu-item *ngFor=\"let menu of menus || employeemenus\" [menu]=\"menu\" [iconOnly]=\"iconOnly\"> </app-sidemenu-item>\n  </div>\n  \n</perfect-scrollbar>\n"

/***/ }),

/***/ "./src/app/top-menu/sidemenu/sidemenu.component.scss":
/*!***********************************************************!*\
  !*** ./src/app/top-menu/sidemenu/sidemenu.component.scss ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/sidemenu/sidemenu.component.ts":
/*!*********************************************************!*\
  !*** ./src/app/top-menu/sidemenu/sidemenu.component.ts ***!
  \*********************************************************/
...
/* harmony import */ var _menu_element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu-element */ "./src/app/top-menu/sidemenu/menu-element.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var SidemenuComponent = /** @class */ (function () {
    function SidemenuComponent(loginservice, router) {
        this.loginservice = loginservice;
        this.router = router;
        this.iconOnly = false;
        this.admin = 'admin';
    ...
    SidemenuComponent.prototype.ngOnInit = function () {
        ...
        this.loginservice.getUserName().subscribe(function (data) {
            if (data.Identifier === _this.admin || data.Identifier === _this.employeeadmin) {
                _this.menus = _menu_element__WEBPACK_IMPORTED_MODULE_2__["adminmenus"];
            }
            else {
                _this.employeemenus = _menu_element__WEBPACK_IMPORTED_MODULE_2__["Employee_menus"];
            }
        }, function (err) {
            if (err instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpErrorResponse"]) {
                if (err.status === 401) {
    ...
    SidemenuComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./sidemenu.component.html */ "./src/app/top-menu/sidemenu/sidemenu.component.html"),
            styles: [__webpack_require__(/*! ./sidemenu.component.scss */ "./src/app/top-menu/sidemenu/sidemenu.component.scss")]
        }),
        __metadata("design:paramtypes", [src_app_services_login_service__WEBPACK_IMPORTED_MODULE_1__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], SidemenuComponent);
...
/***/ "./src/app/top-menu/toolbar-notification/toolbar-notification.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/top-menu/toolbar-notification/toolbar-notification.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/toolbar-notification/toolbar-notification.component.scss":
/*!***********************************************************************************!*\
  !*** ./src/app/top-menu/toolbar-notification/toolbar-notification.component.scss ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/toolbar-notification/toolbar-notification.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/top-menu/toolbar-notification/toolbar-notification.component.ts ***!
  \*********************************************************************************/
...
var ToolbarNotificationComponent = /** @class */ (function () {
    ...
    ToolbarNotificationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./toolbar-notification.component.html */ "./src/app/top-menu/toolbar-notification/toolbar-notification.component.html"),
            styles: [__webpack_require__(/*! ./toolbar-notification.component.scss */ "./src/app/top-menu/toolbar-notification/toolbar-notification.component.scss")]
        }),
...
/***/ "./src/app/top-menu/toolbar/toolbar.component.html":
/*!*********************************************************!*\
  !*** ./src/app/top-menu/toolbar/toolbar.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/toolbar/toolbar.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/top-menu/toolbar/toolbar.component.ts ***!
  \*******************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _toolbar_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toolbar.helper */ "./src/app/top-menu/toolbar/toolbar.helper.ts");
/* harmony import */ var src_app_services_login_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/login.service */ "./src/app/services/login.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ToolbarComponent = /** @class */ (function () {
    function ToolbarComponent(loginservice) {
        ...
        this.toolbarHelpers = _toolbar_helper__WEBPACK_IMPORTED_MODULE_1__["ToolbarHelpers"];
    }
    ...
    ToolbarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./toolbar.component.html */ "./src/app/top-menu/toolbar/toolbar.component.html"),
            styles: [__webpack_require__(/*! ./toolbar.component.scss */ "./src/app/top-menu/toolbar/toolbar.component.scss")]
        }),
...
/***/ "./src/app/top-menu/toolbar/toolbar.helper.ts":
/*!****************************************************!*\
  !*** ./src/app/top-menu/toolbar/toolbar.helper.ts ***!
  \****************************************************/
...
var ToolbarHelpers = {
    ...
    currentUser: {
        photoURL: 'assets/paalan.jpg',
        currentUserName: 'Paala Mugan'
    }
};
...
/*!*********************************************!*\
  !*** ./src/app/top-menu/top-menu.module.ts ***!
  \*********************************************/
/*! exports provided: TopMenuModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TopMenuModule", function() { return TopMenuModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _sidemenu_sidemenu_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sidemenu/sidemenu.component */ "./src/app/top-menu/sidemenu/sidemenu.component.ts");
/* harmony import */ var _sidemenu_item_sidemenu_item_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sidemenu-item/sidemenu-item.component */ "./src/app/top-menu/sidemenu-item/sidemenu-item.component.ts");
...
/* harmony import */ var _toolbar_notification_toolbar_notification_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./toolbar-notification/toolbar-notification.component */ "./src/app/top-menu/toolbar-notification/toolbar-notification.component.ts");
/* harmony import */ var _toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./toolbar/toolbar.component */ "./src/app/top-menu/toolbar/toolbar.component.ts");
/* harmony import */ var _search_bar_search_bar_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./search-bar/search-bar.component */ "./src/app/top-menu/search-bar/search-bar.component.ts");
/* harmony import */ var _fullscreen_fullscreen_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./fullscreen/fullscreen.component */ "./src/app/top-menu/fullscreen/fullscreen.component.ts");
/* harmony import */ var _sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./sidebar/sidebar.component */ "./src/app/top-menu/sidebar/sidebar.component.ts");
/* harmony import */ var _user_menu_user_menu_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./user-menu/user-menu.component */ "./src/app/top-menu/user-menu/user-menu.component.ts");
...
/***/ "./src/app/top-menu/user-menu/user-menu.component.html":
/*!*************************************************************!*\
  !*** ./src/app/top-menu/user-menu/user-menu.component.html ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"toolbar-user-container\">\n\t<button mat-button (click)=\"isOpen = !isOpen\" class=\"toolbar-user-btn\" [class.open]=\"isOpen\" [ngStyle.xs]=\"{'min-width': '70px'}\">\n  \t\t<span fxLayout=\"row\" fxLayoutAlign=\"start center\">\n    \t\t<img class=\"avatar\" [src]=\"'assets/images/avatar.png'\">\n    \t\t<span class=\"name\" fxHide fxShow.gt-xs>{{currentUser?.userName || name | uppercase}}</span>\n    \t\t<mat-icon class=\"icon\" fxHide fxShow.gt-xs>keyboard_arrow_down</mat-icon>\n  \t\t</span>\n  \t</button>\n\n\n  \t<div class=\"dropdown mat-elevation-z1\" [class.open]=\"isOpen\">\n    \t<div class=\"content\">\n      \t\t<mat-nav-list>\n      \t\t\t<mat-list-item>\n      \t\t\t\t<a matLine routerLinkActive=\"active\" (click)=\"nagivateurl()\">Profile</a>\n\t\t\t\t    <button mat-icon-button>\n\t\t\t\t       <mat-icon matTooltip=\"Profile\" (click)=\"nagivateurl()\" routerLinkActive=\"active\">account_circle</mat-icon>\n\t\t\t\t    </button>\n      \t\t\t</mat-list-item>\n      \t\t\t<!-- <mat-list-item>\n      \t\t\t\t<a matLine >Settings</a>\n\t\t\t\t    <button mat-icon-button>\n\t\t\t\t       <mat-icon>settings</mat-icon>\n\t\t\t\t    </button>\n      \t\t\t</mat-list-item> -->\n      \t\t\t<!-- <mat-list-item>\n      \t\t\t\t<a matLine >Help</a>\n\t\t\t\t    <button mat-icon-button>\n\t\t\t\t       <mat-icon>help</mat-icon>\n\t\t\t\t    </button>\n      \t\t\t</mat-list-item> -->\n\n      \t\t\t<mat-divider></mat-divider>\n\n      \t\t\t<mat-list-item>\n      \t\t\t\t<a matLine (click)=\"logout()\">Logout</a>\n\t\t\t\t    <button mat-icon-button>\n\t\t\t\t       <mat-icon matTooltip=\"Logout\" (click)=\"logout()\">exit_to_app</mat-icon>\n\t\t\t\t    </button>\n      \t\t\t</mat-list-item>\n      \t\t</mat-nav-list>\n    \t</div>\n  \t</div>\n</div>"

/***/ }),

/***/ "./src/app/top-menu/user-menu/user-menu.component.scss":
/*!*************************************************************!*\
  !*** ./src/app/top-menu/user-menu/user-menu.component.scss ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./src/app/top-menu/user-menu/user-menu.component.ts":
/*!***********************************************************!*\
  !*** ./src/app/top-menu/user-menu/user-menu.component.ts ***!
  \***********************************************************/
...
var UserMenuComponent = /** @class */ (function () {
    function UserMenuComponent(elementRef, router, loginservice) {
        this.elementRef = elementRef;
        this.router = router;
        this.loginservice = loginservice;
        this.isOpen = false;
    ...
    UserMenuComponent.prototype.ngOnInit = function () {
        ...
        this.loginservice.getUserName().subscribe(function (data) {
            _this.currentUser = data;
            if (_this.currentUser.Identifier == "admin") {
                _this.profileURL = '/profile/adminprofile/';
            }
            else {
                _this.profileURL = '/profile/employeeprofile/';
            }
    ...
    UserMenuComponent.prototype.nagivateurl = function () {
    ...
    UserMenuComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./user-menu.component.html */ "./src/app/top-menu/user-menu/user-menu.component.html"),
            styles: [__webpack_require__(/*! ./user-menu.component.scss */ "./src/app/top-menu/user-menu/user-menu.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], src_app_services_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"]])
    ], UserMenuComponent);
...
var API_END_POINT = "/api";
var COMPANY_URL = API_END_POINT + "/company/";
var EMPLOYEE_URL = API_END_POINT + "/employee/";
var FRAME_MATERIAL_URL = API_END_POINT + "/frame-material/";
var BRAND_URL = API_END_POINT + "/brand/";
var FRAME_MODEL_URL = API_END_POINT + "/frame-model/";
var LENS_TYPE_URL = API_END_POINT + "/lens-type/";
var BOXES_URL = API_END_POINT + "/boxes/";
var REGISTER_ACTION = 'register';
var ADMIN_LOGIN_ACTION = 'login';
var EMPLOYEE_LOGIN_ACTION = 'employee-login';
var USERNAME_ACTION = 'username';
var GET_ACTION = "get";
var GET_ACTION_ONE = "getone";
var ADD_ACTION = "add";
var UPDATE_ACTION = "update";
var DELETE_ACTION = "delete";
var FIND_ACTION = "find";
var FIND_ACTION_ONE = "/findone";
var FORGET_PASSWORD_ACTION = "forget-password";
var Utils = /** @class */ (function () {
    function Utils() {
    }
    Utils.getSignupURL = function () {
        return COMPANY_URL + REGISTER_ACTION;
    };
    Utils.getOneSignupURL = function () {
        return COMPANY_URL + GET_ACTION_ONE;
    };
    Utils.addSignupURL = function () {
        return COMPANY_URL;
    };
    Utils.updateCompanyURL = function () {
        return COMPANY_URL + UPDATE_ACTION;
    };
    Utils.deleteSignupURL = function () {
        return COMPANY_URL + DELETE_ACTION;
    };
    Utils.getUserNameURL = function () {
        return COMPANY_URL + USERNAME_ACTION;
    };
    Utils.adminLoginURL = function () {
        return COMPANY_URL + ADMIN_LOGIN_ACTION;
    };
    Utils.forgetPasswordURL = function () {
        return COMPANY_URL + FORGET_PASSWORD_ACTION;
    };
    Utils.getforgetPasswordURL = function () {
        return COMPANY_URL + FORGET_PASSWORD_ACTION;
    };
    Utils.UpdateforgetPasswordURL = function () {
        return COMPANY_URL + FORGET_PASSWORD_ACTION;
    };
    /*loginurl*/
    Utils.employeeLoginURL = function () {
...
module.exports = __webpack_require__(/*! /home/ubuntu/development/git/optic-visions/client/src/main.ts */"./src/main.ts");
