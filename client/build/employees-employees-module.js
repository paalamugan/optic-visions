...
var AddEmployeesComponent = /** @class */ (function () {
    ...
    AddEmployeesComponent.prototype.OnSubmit = function () {
        ...
        this.employeeservice.addEmployee(formData).subscribe(function (response) {
            ...
            _this.employee = new src_app_models_employee__WEBPACK_IMPORTED_MODULE_1__["Employee"]("", '', '', '', '', '', null, null, '', '', '', _this.companysignup);
...
var ListEmployeesComponent = /** @class */ (function () {
    function ListEmployeesComponent(employeeservice, loginservice, router, dialog) {
        ...
        this.router = router;
        this.dialog = dialog;
        this.displayedColumns = ['position', 'avatar', 'employeeName', 'employeeEmail', 'address', 'mobileNumber', 'DOB', 'DOJ', 'adminAccess', 'edit'];
        this.employees = [];
    ...
    ListEmployeesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_employee_service__WEBPACK_IMPORTED_MODULE_2__["EmployeeService"], src_app_services_login_service__WEBPACK_IMPORTED_MODULE_5__["LoginService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]])
